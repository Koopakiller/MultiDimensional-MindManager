...
var DBValueProvider_js_1 = require("../DBValueProvider.js");
var ImportComponent = (function () {
    function ImportComponent(_financesService, _router, _globalLoadingIndicatorService) {
    ...
    Object.defineProperty(ImportComponent.prototype, "selectedUser", {
        get: function () {
    ...
    ImportComponent.prototype.processFileInputChange = function ($event) {
    ...
    ImportComponent.prototype.import = function (index) {
        var _this = this;
        this._globalLoadingIndicatorService.addLoadingProcess();
        setTimeout(function () {
            _this.nextStep();
    ...
    Object.defineProperty(ImportComponent.prototype, "transactionsHasErrors", {
        get: function () {
    ...
    ImportComponent.prototype.submitData = function () {
        var _this = this;
        this._globalLoadingIndicatorService.addLoadingProcess();
    ...
    ImportComponent.prototype.toggleDetails = function (i) {
    ...
    ImportComponent.prototype.initCurrentStep = function () {
        this.currentStep = this.steps[0];
    };
    ImportComponent.prototype.nextStep = function () {
        this.currentStep = this.steps[this.steps.indexOf(this.currentStep) + 1];
    };
    // Add Person ####################################################################################
    ImportComponent.prototype.addPerson = function (name) {
        if (name === void 0) { name = ""; }
        this.showAddPersonPopup = true;
        this.suggestedNewPersonName = name;
    };
    ImportComponent.prototype.closeAddPersonPopup = function (pvm) {
        this.showAddPersonPopup = false;
        this.suggestedNewPersonName = "";
        if (pvm) {
