...
GO
PRINT N'Creating [dbo].[CurrencyIdentifier]...';
...
GO
PRINT N'Creating [dbo].[FK_CurrencyIdentifier_Currencies]...';


GO
ALTER TABLE [dbo].[CurrencyIdentifier] WITH NOCHECK
    ADD CONSTRAINT [FK_CurrencyIdentifier_Currencies] FOREIGN KEY ([CurrencyId]) REFERENCES [dbo].[Currencies] ([Id]);
...
GO
ALTER TABLE [dbo].[CurrencyIdentifier] WITH CHECK CHECK CONSTRAINT [FK_CurrencyIdentifier_Currencies];
